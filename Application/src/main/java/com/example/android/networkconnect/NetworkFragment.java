    ...
    private class DownloadTask extends AsyncTask<String, Integer, DownloadTask.Result> {
        ...
        private String downloadUrl(URL url) throws IOException {
            ...
            try {
                ...
                if (stream != null) {
                    // Converts Stream to String with max length of 8192.
                    result = readStream(stream, 8192);
                    result = result.substring(result.indexOf("Confira o resultado da Mega Sena")-1);
                    result = result.substring(1, result.indexOf("(adsbygoogle")-1);
                    numbers = result.substring(result.indexOf(":")+1);
                    numbers = numbers.substring(0,2) + "-" + numbers.substring(2,4) + "-" + numbers.substring(4,6)
                            + "-" + numbers.substring(6,8) + "-" + numbers.substring(8,10) + "-" + numbers.substring(10,12);
                    result = result.substring(0, result.indexOf(":")+1) + " " + numbers;
